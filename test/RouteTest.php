...
class RouteTest extends \PHPUnit_Framework_TestCase {
  ...
  protected $routes = Array(
      Array('/' => '/pages/home', "/^\\/$/", Array()),
      Array('/about' => '/pages/about', "/^\\/about$/", Array()),
      Array('/_:action' => '/admin/:action', "/^\\/([^\\/]+)$/", Array(':action')),
      Array('/add/:number1+:number2' => '/calculator/add/:number1/:number2', "/^\\/add\\/([^\\/]+)\\+([^\\/]+)$/", Array(':number1', ':number2'))
  );
  ...
  public function provodeRequestData() {
    $data = Array();
